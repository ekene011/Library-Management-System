<!-- -- /admin/borrowed_books.php (Admin Borrowed Books Management) -->
<?php
session_start();
...
$query = "SELECT loans.id AS loan_id, users.name AS user_name, users.email, books.title,books.cover, books.author, loans.borrow_date, loans.due_date 
          FROM loans 
